public class Demo {
    public static void main(String[] args) {
        ...
        store.addProduct(new Donut("Long John with sprinkles", 1.75, 1.25, Frosting.Chocolate, Filling.Bavarian, true));
        store.addProduct(new Donut("Creme Filled Donut", 1.75, 1, Frosting.Unfrosted, Filling.Creme, false));
